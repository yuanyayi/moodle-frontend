  ...
  <a-card :bordered="false" style="margin-bottom: 24px">
    <a-card title="直播基本信息">
      <a-descriptions :column="2" :bordered="false" :dataSource="detail" :size="'small'">
        <a-descriptions-item v-for="(desc,field) in fieldsMap" :label="desc.label">{{ detail[field] }} </a-descriptions-item>
      </a-descriptions>
    </a-card>
    ...
    <div v-for="(detail, index) in tableList" class="tableItem">
      ...
      <div class="content">
        ...
        <a-space>
          ...
          <a-button v-if="detail.replay" class="greenBtn" @click="gotoReplayList(detail.id)">直播回放</a-button>
